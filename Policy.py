...
class AttractionPolicy(Policy):
    """Class to represent a policy with attraction."""

    def __init__(self, g: float = 0.1, interaction_radius: float = 1.0, eta: float = 1):
        """Initialize the attraction policy.

        Args:
            g (float): Attraction level.
            interaction_radius (float): Interaction radius.
            eta (float): Noise level.
        """
        self.g = g
